...
/**
 * <i>native declaration : /usr/include/libavcodec/avcodec.h:5653</i><br>
...
public class AVCodecContext extends Structure {
	 ...
	 * In general use of this field by muxers is not recommended.<br>
	 ...
	 * May be overriden by the decoder if it knows better.<br>
	 * - encoding: Set by user.<br>
	 ...
	 * - encoding: Set by user.<br>
	 * - decoding: Set by libavcodec.<br>
	 * @see com.acuitus.wrapffmpeg.AvutilLibrary#AVSampleFormat<br>
	 * < sample format<br>
	 ...
	 * is assumed to be released immediately upon return.<br>
	...
	/**
	 * If true, only parsing is done. The frame data is returned.<br>
	 * Only MPEG audio decoders support this now.<br>
	 * - encoding: unused<br>
	 * - decoding: Set by user
	 */
	 ...
	 * internal_buffers<br>
	 * Don't touch, used by libavcodec default_get_buffer().<br>
	 * @deprecated this field was moved to an internal context<br>
	 * C type : void*
	 */
	...
	/**
	 * Influence how often B-frames are used.<br>
	 * - encoding: Set by user.<br>
	 * - decoding: unused
	 */
	 ...
	 * data Libav cannot instantiate itself. Please refer to the<br>
	 * Libav HW accelerator documentation to know how to fill this<br>
	...
	/**
	 * Determine which LPC analysis algorithm to use.<br>
	 * - encoding: Set by user<br>
	 * - decoding: unused<br>
	 * @see AVLPCType<br>
	 * C type : AVLPCType
	...
	/**
	 * Whether this is a copy of the context which had init() called on it.<br>
	 * This is used by multithreading - shared tables and picture pointers<br>
	 * should be freed from the original context only.<br>
	 * - encoding: Set by libavcodec.<br>
	 * - decoding: Set by libavcodec.<br>
	 ...
	 * from another thread, which allows faster multithreaded decoding.<br>
	...
	/**
	 * Used to request a sample format from the decoder.<br>
	 * - encoding: unused.<br>
	 * - decoding: Set by user.<br>
	 * @see com.acuitus.wrapffmpeg.AvutilLibrary#AVSampleFormat<br>
	 * C type : AVSampleFormat
	...
	/** <i>native declaration : /usr/include/libavcodec/avcodec.h:5609</i> */
	...
	/** <i>native declaration : /usr/include/libavcodec/avcodec.h:5643</i> */
	...
	/** <i>native declaration : /usr/include/libavcodec/avcodec.h:5644</i> */
