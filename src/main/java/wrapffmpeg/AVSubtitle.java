...
/**
 * <i>native declaration : libavcodec/avcodec.h:1908</i><br>
...
public class AVSubtitle extends Structure {
	...
	public wrapffmpeg.AVSubtitleRect.ByReference[] rects;
	 ...
	 */
	public AVSubtitle(short format, int start_display_time, int end_display_time, int num_rects, wrapffmpeg.AVSubtitleRect.ByReference rects[], long pts) {
		super();
		this.format = format;
