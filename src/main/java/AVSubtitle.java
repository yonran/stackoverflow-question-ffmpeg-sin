...
/**
 * <i>native declaration : /usr/include/libavcodec/avcodec.h:5911</i><br>
...
public class AVSubtitle extends Structure {
	 ...
	 */
	public AVSubtitle(short format, int start_display_time, int end_display_time, int num_rects, AVSubtitleRect.ByReference rects[], long pts) {
		super();
		this.format = format;
